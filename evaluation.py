...
def main():
    ...
    print("=" * 70)
    print("\nGenerated files:")
    print("- test_results_small.json")
    print("- test_results_medium.json")
    print("- test_results_large.json")
    print("- test_results_comparison.json")
    print("\nNow analyze these results to create your results_analysis.md report!")
